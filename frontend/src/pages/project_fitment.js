...
const ProjectFitment = () => {
                ...
                .then(data => {
                    if (data.error) {
                        ...
                        setFormData(prev => ({
                            ...
                            projectFitment: data.project_fitment || '',
    ...
    const handleSubmit = async () => {
        const { 
            ...
            detailedFeedback, result, organizationalFitment, customerCommunication,
            continuousLearning, attitudePersonality, communicationSkills, projectFitment 
        } = formData;

        if (!detailedFeedback || !result || !organizationalFitment || !customerCommunication || 
            !continuousLearning || !attitudePersonality || !communicationSkills || !projectFitment) {
            ...
            if (data.success) {
                ...
                setTimeout(() => {
                    ...
                    if (window.opener) {
                        ...
                        window.location.href = `projectfitment.html?success=true&candidateEmail=${encodeURIComponent(candidateEmail)}&position=${encodeURIComponent(position)}`;
                    }
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" id="rrfId" placeholder="" value={formData.rrfId} onChange={handleInputChange} /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="candidateName" placeholder="" value={formData.candidateName} readOnly /></td>
                            </tr>
                            <tr>
                                <td className="details">Date of Interview</td>
                                <td><input type="text" id="interviewDate" value={formData.interviewDate} readOnly /></td>
                            </tr>
                            <tr>
                                <td className="details">Interviewer Mail</td>
                                <td><input type="text" id="interviewerName" placeholder="" value={formData.interviewerName} readOnly /></td>
                            </tr>
                            <tr>
                                <td className="details">TAG Team Member</td>
                                <td><input type="text" id="hrEmail" placeholder="" value={formData.hrEmail} readOnly /></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div className="feedback-section">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td className="header">Project Fitment: *</td>
                                <td>
                                    <textarea 
                                        id="projectFitment" 
                                        placeholder="Enter feedback..." 
                                        required
                                        value={formData.projectFitment}
                                        onChange={handleInputChange}
                                    />
                                </td>
                            </tr>
