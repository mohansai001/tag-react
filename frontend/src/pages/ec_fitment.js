...
const ECFitment = () => {
    ...
    const handleSubmit = async () => {
        const { 
            ...
            continuousLearning, attitudePersonality, communicationSkills
        } = formData;
            ...
            if (data.success) {
                ...
                setTimeout(() => {
                    ...
                    if (window.opener) {
                        ...
                        window.location.href = `ecfitment.html?success=true&candidateEmail=${encodeURIComponent(candidateEmail)}&position=${encodeURIComponent(position)}`;
                    }
